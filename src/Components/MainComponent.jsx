...
import logo from "../assets/images/local.gif";
  ...
  return (
    ...
    >
        ...
        <div className="desktop:flex phone:flex">
          <div>
            <div className="flex justify-between items-center">
              <img
                className="desktop:w-24 rounded-3xl absolute top-3 left-6 phone:w-16"
                src={logo}
              />
              <img
                src={sideBar ? close : search}
                alt="menu"
                className="desktop:invisible phone:visible phone:bg-transparent phone:w-12 z-20 absolute top-2 right-6 phone:mt-3"
            ...
            <div className="desktop:flex desktop:flex-row desktop:items-center desktop:my-96 desktop:mx-2  phone:flex phone:flex-col phone:items-center phone-justify-center phone:my-96 phone:-mx-16">
              ...
              <div className="desktop:flex desktop:flex-col desktop:mx-4 desktop:mb-4 desktop:mt-36 phone:flex phone:flex-row phone:items-center phone:-ml-32">
                <img
      ...
      >
        ...
        <form
          className="search desktop:m-3 desktop:flex  desktop:mx-5 desktop:mt-6 phone:m-3 phone:flex phone:mx-5 phone:mt-96"
